...
public final class ChatServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<ma.enset.stubs.Chat.ChatRequest,
      ma.enset.stubs.Chat.ChatResponse> getChatMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "chat",
      requestType = ma.enset.stubs.Chat.ChatRequest.class,
      responseType = ma.enset.stubs.Chat.ChatResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
  public static io.grpc.MethodDescriptor<ma.enset.stubs.Chat.ChatRequest,
      ma.enset.stubs.Chat.ChatResponse> getChatMethod() {
    io.grpc.MethodDescriptor<ma.enset.stubs.Chat.ChatRequest, ma.enset.stubs.Chat.ChatResponse> getChatMethod;
    if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
      synchronized (ChatServiceGrpc.class) {
        if ((getChatMethod = ChatServiceGrpc.getChatMethod) == null) {
          ChatServiceGrpc.getChatMethod = getChatMethod = 
              io.grpc.MethodDescriptor.<ma.enset.stubs.Chat.ChatRequest, ma.enset.stubs.Chat.ChatResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.BIDI_STREAMING)
              .setFullMethodName(generateFullMethodName(
                  "ChatService", "chat"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Chat.ChatRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  ma.enset.stubs.Chat.ChatResponse.getDefaultInstance()))
  ...
  public static abstract class ChatServiceImplBase implements io.grpc.BindableService {
    ...
    public io.grpc.stub.StreamObserver<ma.enset.stubs.Chat.ChatRequest> chat(
        io.grpc.stub.StreamObserver<ma.enset.stubs.Chat.ChatResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            asyncBidiStreamingCall(
              new MethodHandlers<
                ma.enset.stubs.Chat.ChatRequest,
